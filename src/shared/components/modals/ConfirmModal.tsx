...
export default function ConfirmModal({
  ...
  }, [cancelLabel, confirmLabel, message, open, title, visible]);
  ...
  return createPortal(
    <div
      className={`fixed inset-0 z-[110] flex flex-col items-center p-5 transition-colors duration-200 ${closing || entering ? "bg-transparent" : "bg-overlay backdrop-blur-sm"}`}
      onClick={() => {
        if (!closing) onClose();
      }}
    >
