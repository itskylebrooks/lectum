...
export default function FinishBookModal({
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError("Lectum could not save this completion. Please try again.");
    } finally {
      setSubmitting(false);
    }
  }
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-[1.5rem] border border-subtle bg-surface p-4">
              <div className="flex items-center justify-between gap-3">
                <BookBadge tone={selectedRating.tone}>
              ...
              <div className="mt-4">
                <input
                  ...
                  onChange={(event) =>
                    setRating(
                      getBookRatingFromIndex(Number(event.target.value)),
                    )
                  }
